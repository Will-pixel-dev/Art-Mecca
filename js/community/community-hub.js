...
class CommunityHub {
  constructor() {
    ...
    this.dailyPrompts = [
      { title: "At the Top of the World", description: "Create artwork depicting the highest peaks, both literal and metaphorical. Show us what being 'at the top' means to you.", tags: ["mountain", "achievement", "perspective", "landscape"] },
      { title: "Breathe", description: "Capture the essence of breath, life, and moments of calm. Show us what it means to truly breathe.", tags: ["calm", "life", "meditation", "peace"] },
      { title: "Fallen", description: "Explore themes of descent, loss, or transformation. What does it mean to have fallen?", tags: ["descent", "transformation", "metaphor", "emotion"] },
      { title: "A Thousand Words", description: "Create an image that tells a complex story without using any text. Let your art speak volumes.", tags: ["storytelling", "narrative", "expression", "communication"] },
      { title: "Echoes of Silence", description: "Depict the powerful presence of silence and the echoes it leaves behind.", tags: ["quiet", "reflection", "space", "atmosphere"] },
      { title: "Uncharted Waters", description: "Venture into the unknown. Show us exploration, discovery, and new beginnings.", tags: ["exploration", "adventure", "unknown", "journey"] },
      { title: "Forgotten Memories", description: "Bring to life memories that have faded but not disappeared entirely.", tags: ["memory", "nostalgia", "past", "emotion"] },
      { title: "Neon Dreams", description: "Create a vibrant, neon-infused artwork that captures the energy of the night.", tags: ["neon", "night", "vibrant", "urban"] },
      { title: "Silent Echo", description: "Depict the powerful presence of silence and the echoes it leaves behind.", tags: ["quiet", "reflection", "space", "atmosphere"] },
      { title: "Golden Hour", description: "Capture the magic of golden hour light in your artwork.", tags: ["lighting", "warm", "magic", "sunset"] }
    ];

    // Monthly challenge themes (rotating)
    this.monthlyThemes = [
      { title: '"Mythical Realms Reimagined"', description: 'Take a classic mythical creature or legend and give it a fresh, unexpected twist. What would a phoenix look like in a cyberpunk world? How does a dragon adapt to climate change? Your imagination is the only limit.', tags: ['mythology', 'fantasy', 'reimagine', 'worldbuilding'] },
      { title: '"Urban Echoes"', description: 'Capture the hidden stories of the city - the forgotten corners, the midnight alleys, the quiet moments between skyscrapers. Show us the soul of the city that others overlook.', tags: ['urban', 'city', 'hidden', 'storytelling'] },
      { title: '"Ethereal Visions"', description: 'Explore the space between dreams and reality. Create artwork that feels both familiar and otherworldly, where the boundaries of imagination blur.', tags: ['dreams', 'surreal', 'ethereal', 'fantasy'] },
      { title: '"Elements Unleashed"', description: 'Channel the raw power of earth, wind, fire, and water. Show us the elemental forces that shape our world in your unique visual language.', tags: ['elements', 'nature', 'power', 'force'] },
      { title: '"Timeless Portraits"', description: 'Create portraits that transcend time - figures that could belong to any era, any culture, any world. Tell a story through a single gaze.', tags: ['portraits', 'timeless', 'expression', 'character'] },
      { title: '"Mechanical Dreams"', description: 'Blend organic life with mechanical precision. Create creatures and worlds where technology and nature coexist in harmony or conflict.', tags: ['steampunk', 'cyber', 'mechanical', 'organic'] },
      { title: '"Cosmic Wanderers"', description: 'Journey through the cosmos - explore strange new worlds, alien landscapes, and the infinite possibilities of space.', tags: ['space', 'cosmic', 'alien', 'infinite'] },
      { title: '"Whispers of the Past"', description: 'Bring history to life through art. Reimagine ancient civilizations, lost cultures, and the echoes of bygone eras.', tags: ['history', 'ancient', 'culture', 'heritage'] },
      { title: '"Flora & Fauna Fantasia"', description: 'Create a vibrant celebration of the natural world. Reimagine plants and animals in fantastical ways that celebrate biodiversity.', tags: ['nature', 'fantasy', 'animals', 'plants'] },
      { title: '"Architectural Dreams"', description: 'Design impossible structures - buildings that defy physics, cities that float, homes that breathe. Show us the architecture of imagination.', tags: ['architecture', 'design', 'impossible', 'dreams'] },
      { title: '"Shadow & Light"', description: 'Explore the dramatic interplay between shadow and light. Create artwork where the darkness reveals as much as it conceals.', tags: ['shadows', 'light', 'contrast', 'mystery'] },
      { title: '"Festival of Colors"', description: 'Celebrate the joy of color - create vibrant, energetic artwork that captures the spirit of celebration and cultural festivity.', tags: ['color', 'celebration', 'festival', 'vibrant'] }
    ];

    // Weekly challenge themes
    this.weeklyThemes = [
      { title: '"Urban Jungle"', description: 'Create artwork that blends city architecture with natural elements. Think vines growing on skyscrapers, tree roots breaking through pavement, or wildlife adapting to urban environments.', tags: ['cityscape', 'nature', 'surreal', 'contrast'] },
      { title: '"Golden Hour Glow"', description: 'Capture the magic of the golden hour - that brief moment when the sun casts everything in warm, glowing light. Show us the beauty of transition.', tags: ['golden hour', 'lighting', 'warm', 'transition'] },
      { title: '"Silent Stories"', description: 'Create artwork that tells a story without words. Let the composition, color, and mood convey a narrative that speaks to the viewer.', tags: ['storytelling', 'narrative', 'silence', 'expression'] },
      { title: '"Fractured Realities"', description: 'Explore the beauty in broken things. Show us shattered perspectives, fragmented visions, and the art that emerges from the pieces.', tags: ['fractured', 'abstract', 'broken', 'perspective'] },
      { title: '"Midnight Musings"', description: 'Capture the introspection and mystery of the midnight hour. Create artwork that feels intimate, quiet, and deeply personal.', tags: ['night', 'introspection', 'quiet', 'intimate'] },
      { title: '"Abstract Emotions"', description: 'Translate feelings into abstract form. Let color, shape, and texture express what words cannot capture.', tags: ['abstract', 'emotion', 'feeling', 'expression'] },
      { title: '"Culinary Canvas"', description: 'Treat food as art - create stunning compositions that celebrate the beauty and creativity of cuisine.', tags: ['food', 'culinary', 'creative', 'composition'] },
      { title: '"Dance of the Elements"', description: 'Capture movement and energy in a single frame. Show us the grace, power, and beauty of things in motion.', tags: ['dance', 'movement', 'energy', 'grace'] },
      { title: '"Futuristic Visions"', description: 'Imagine the world of tomorrow. Create artwork that explores the possibilities of future technology, society, and human evolution.', tags: ['future', 'technology', 'futuristic', 'imagination'] },
      { title: '"Organic Abstracts"', description: 'Find the abstract beauty in the natural world. Create compositions inspired by organic forms, patterns, and textures.', tags: ['organic', 'abstract', 'nature', 'patterns'] },
      { title: '"Cultural Fusion"', description: 'Blend cultural elements from different traditions and eras to create something entirely new and beautiful.', tags: ['culture', 'fusion', 'diverse', 'creative'] },
      { title: '"Dreamscapes"', description: 'Bring your dreams to life. Create surreal landscapes and scenes that exist only in the realm of imagination.', tags: ['dreams', 'surreal', 'landscape', 'imagination'] }
    ];
  ...
  loadWeeklyChallenge() {
    ...
    document.getElementById('weekly-description').textContent = theme.description;
    document.getElementById('weekly-date-range').textContent = `Week ${weekNumber} · ${dateRange}`;
    document.getElementById('weekly-prize').innerHTML = `<i class="fas fa-gem"></i> Prize: Featured artist spot + 500 community points`;
  ...
  loadMonthlyChallenge() {
    ...
    document.getElementById('monthly-description').textContent = theme.description;
    document.getElementById('monthly-date').textContent = `${monthName} · ${theme.tags[0] || 'Creative'}`;
    document.getElementById('monthly-prize').innerHTML = `<i class="fas fa-trophy"></i> Prize: $100 gift card + 1-year premium membership + Featured exhibition`;
  ...
  loadYearlyChallenge() {
    ...
    const yearlyData = {
      ...
      description: 'Document transformation through 12 themed chapters - one for each month. From personal growth to environmental change, from character evolution to artistic style development. Create a cohesive body of work that tells a story of change and emergence.',
      tags: ['transformation', 'growth', 'evolution', 'series'],
      year: `${year} Grand Challenge`,
      prize: '$5,000 + Solo exhibition + Mentorship program + "Artisan of the Year" title + Soul Chaser Badge'
    };

    document.getElementById('yearly-title').textContent = yearlyData.title;
    document.getElementById('yearly-description').textContent = yearlyData.description;
    document.getElementById('yearly-date').textContent = yearlyData.year;
    document.getElementById('yearly-prize').innerHTML = `<i class="fas fa-crown"></i> Grand Prize: ${yearlyData.prize}`;
...
async checkAdminStatus() {
  try {
    ...
    if (doc.exists) {
      const data = doc.data();
      this.isAdmin = data.role === 'admin' || data.role === 'moderator' || data.isAdmin === true;
...
getIntuitChallenges() {
    ...
    const intuitYearly = {
        ...
        prize: 'Grand Master Badge + Featured Artist + Solo Exhibition + Design a Challenge',
        prizeValue: 1000,
        participants: 0,
        submissions: 0,
        status: 'active',
  ...
  async uploadHeroLayer(file, layer) {
    if (!this.isAdmin) {
      this.showToast('You do not have permission to change the hero image.', 'error');
      return;
    }
    ...
    try {
      ...
      await firebase.firestore().collection('settings').doc('hubHero').set({
  ...
  loadDailyChallenge() {
    ...
    document.getElementById('daily-prompt-title').textContent = todayPrompt.title;
    document.getElementById('daily-prompt-description').textContent = todayPrompt.description;
    document.getElementById('challenge-date').textContent = today.toLocaleDateString('en-US', {
      weekday: 'long',
      year: 'numeric',
      month: 'long',
      day: 'numeric'
  ...
  async loadChallengeStats() {
    try {
      const participantsSnapshot = await firebase.firestore().collection('challengeParticipants').get();
      const submissionsSnapshot = await firebase.firestore().collection('submissions').where('type', '==', 'challenge').get();

      const participants = participantsSnapshot.size || 0;
      const submissions = submissionsSnapshot.size || 0;

      document.getElementById('daily-participants').textContent = participants > 0 ? participants : '0';
      document.getElementById('daily-submissions').textContent = submissions > 0 ? submissions : '0';
    } catch (error) {
      console.error('Error loading challenge stats:', error);
      document.getElementById('daily-participants').textContent = Math.floor(Math.random() * 100) + 50;
      document.getElementById('daily-submissions').textContent = Math.floor(Math.random() * 70) + 30;
    }
  }
  ...
  async loadCommunityStats() {
    try {
      ...
      const artworksSnapshot = await firebase.firestore().collection('artworks').where('status', '==', 'published').get();

      document.getElementById('total-members').textContent = usersSnapshot.size > 0 ? usersSnapshot.size : '0';
      document.getElementById('total-artworks').textContent = artworksSnapshot.size > 0 ? artworksSnapshot.size : '0';
      document.getElementById('active-challenges').textContent = '3';
      document.getElementById('trending-artworks').textContent = '12';

      document.getElementById('cta-members').textContent = usersSnapshot.size > 0 ? usersSnapshot.size : '0';
      document.getElementById('cta-artworks').textContent = artworksSnapshot.size > 0 ? artworksSnapshot.size : '0';
      document.getElementById('cta-submissions').textContent = Math.floor(Math.random() * 500) + 200;
    } catch (error) {
...
async loadFeaturedArtworks() {
  ...
  try {
    ...
    grid.innerHTML = topArtworks.map(art => `
  ...
  async loadTopCreators() {
    ...
    try {
      ...
      usersSnapshot.forEach(doc => {
        ...
        const points = Math.round((artworks * 10) + (followerCount * 2) + (likes * 0.5));
      ...
      grid.innerHTML = topUsers.map((user, index) => {
        const rank = index + 1;
...
async loadBulletinPosts() {
  ...
  setupSuggestionBox() {
    ...
    form.addEventListener('submit', async (e) => {
      ...
      const name = document.getElementById('suggestion-name').value.trim() || 'Anonymous';
      ...
      try {
        ...
        this.showToast('Error submitting suggestion. Please try again.', 'error');
      }
    });
  }
  ...
  showChallengeModal(challengeType) {
    ...
    const promptMap = {
      daily: document.getElementById('daily-prompt-title')?.textContent || 'Create something amazing!',
  ...
  shareChallenge() {
    const prompt = document.getElementById('daily-prompt-title')?.textContent || 'Today\'s challenge';
  ...
  setupEventListeners() {
    ...
    document.getElementById('daily-challenges-btn')?.addEventListener('click', () => {
      window.location.href = '/pages/community/challenges.html';
    });

    document.getElementById('weekly-start-btn')?.addEventListener('click', () => {
      this.handleStartChallenge('weekly');
    });
    document.getElementById('weekly-share-btn')?.addEventListener('click', () => {
      this.shareChallenge();
    });
    ...
    document.getElementById('monthly-start-btn')?.addEventListener('click', () => {
      this.handleStartChallenge('monthly');
    });
    document.getElementById('monthly-share-btn')?.addEventListener('click', () => {
      this.shareChallenge();
    });
    ...
    document.getElementById('yearly-start-btn')?.addEventListener('click', () => {
      this.handleStartChallenge('yearly');
    });
    document.getElementById('yearly-share-btn')?.addEventListener('click', () => {
      this.shareChallenge();
    });
    ...
    document.getElementById('submit-bulletin-post')?.addEventListener('click', () => {
  ...
  if (!this.isAdmin) {
    this.showToast('You do not have permission to post announcements.', 'error');
    return;
  }
  ...
  try {
    await firebase.firestore().collection('bulletinPosts').add({
      title: title,
      content: content,
      link: link || '',
      author: this.currentUser?.displayName || this.currentUser?.email || 'Admin',
      createdAt: firebase.firestore.FieldValue.serverTimestamp()
    });
...
setupBulletinToggle() {
  ...
  if (toggleBtn && adminPanel) {
    toggleBtn.addEventListener('click', () => {
      ...
      if (!this.isAdmin) {
        this.showToast('You must be an admin to post announcements.', 'error');
        return;
      }
...
if (canvas) {
  ...
  const rainbowColors = [
    "#ff0040", "#ff6b00", "#ffc72e", "#4ff3a6",
    "#58ebfe", "#0088ff", "#ad03fc", "#ff00ea"
  ];
