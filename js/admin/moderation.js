...
class ModerationDashboard {
  ...
  async approveReport(reportId) {
    if (!confirm("⚠️ Approve this report? The artwork will be taken down."))
      return;
      ...
      if (newWarnings >= 3) {
        ...
        if (typeof authManager !== "undefined") {
          await authManager.createNotification(userId, "nsfw_banned", {
            message:
              "🚫 You have been banned for exceeding the NSFW warning limit.",
          });
        }
