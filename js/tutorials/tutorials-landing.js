...
function initParticles() {
    ...
    initParticles();
        ...
        console.log('✅ tutorialData loaded, tutorials:', tutorialData.getAllTutorials().length);
    ...
    function loadFeaturedTutorials() {
        ...
        featuredGrid.innerHTML = featuredTutorials.map(tutorial => {
            ...
            const imagePath = tutorial.image || '../../images/tutorials/placeholder.jpg';
    ...
    function loadAllTutorials() {
        ...
        tutorialsGrid.innerHTML = filteredTutorials.map((tutorial, index) => {
            const category = tutorialData.categories.get(tutorial.category);
            const imagePath = tutorial.image || '../../images/tutorials/placeholder.jpg';
    ...
    function animateCountUp(element, targetValue, duration = 2000) {
        ...
        const hasSuffix = typeof targetValue === 'string' && /[KkMm]$/.test(targetValue);
        let suffix = '';
        if (hasSuffix) {
        ...
        const actualStart = !isNaN(currentNum) && currentNum > 0 ? currentNum : startValue;
        ...
        function updateCount(currentTime) {
            ...
            const currentValue = actualStart + (numericTarget - actualStart) * easeOutCubic;
