...
class TutorialData {
    ...
    init() {
        ...
        console.log('✅ TutorialData loaded with', this.tutorials.size, 'tutorials');
    }
    ...
    loadTutorials() {
        ...
        this.tutorials.set('character-design', {
            ...
            description: 'Explore different methods for creating compelling characters that tell a story through their design.',
            ...
            date: '2023-10-15',
            tags: ['character', 'design', 'silhouette', 'shape language', 'personality']
        });

        this.tutorials.set('creature-design', {
            id: 'creature-design',
            title: 'Creature Design Fundamentals',
            description: 'Learn to design believable creatures from mythology and imagination - anatomy, ecology, and visual storytelling.',
            category: 'character-design',
            difficulty: 'intermediate',
            duration: 40,
        ...
        this.tutorials.set('color-theory-fundamentals', {
            ...
            description: 'Learn the basics of color theory - color wheel, harmonies, temperature, and practical application in digital art.',
            ...
            author: 'Dr. Kenji Tanaka',
            date: '2023-08-15',
            tags: ['color theory', 'color wheel', 'harmonies', 'temperature', 'psychology']
        });

        this.tutorials.set('lighting-masterclass', {
            id: 'lighting-masterclass',
            title: 'Lighting Masterclass',
            description: 'Master the properties of light, shadow types, and how to render dramatic lighting conditions in your artwork.',
            category: 'color-theory',
            difficulty: 'advanced',
            duration: 45,
        ...
        this.tutorials.set('atmospheric-perspective', {
            ...
            description: 'Learn how to create depth and atmosphere in your artwork using color, value, and atmospheric effects.',
            category: 'color-theory',
            difficulty: 'intermediate',
            duration: 35,
        ...
        this.tutorials.set('digital-painting-basics', {
            ...
            description: 'Learn the fundamentals of digital painting including brush settings, layer management, and basic rendering techniques.',
        ...
        this.tutorials.set('brush-techniques', {
            ...
            description: 'Master different brush types, create custom brushes, and learn when to use each technique for optimal results.',
            category: 'digital-painting',
            difficulty: 'intermediate',
            duration: 30,
            ...
            author: 'Maria Rodriguez',
            date: '2024-01-15',
            tags: ['brushes', 'techniques', 'custom brushes', 'digital painting', 'texture']
        });

        this.tutorials.set('landscape-masterclass', {
            id: 'landscape-masterclass',
            title: 'Landscape Painting Masterclass',
            description: 'Learn to paint stunning landscapes - from composition and color to texture and atmospheric effects.',
            category: 'digital-painting',
            difficulty: 'intermediate',
            duration: 40,
        ...
        this.tutorials.set('facial-anatomy-basics', {
            ...
            description: 'Understand the fundamental structure of the human face - proportions, planes, and key landmarks for realistic portraits.',
        ...
        this.tutorials.set('nose-rendering-tutorial', {
            ...
            description: 'Complete guide to nose anatomy and rendering techniques - from structure to realistic shading.',
            category: 'facial-features',
            difficulty: 'beginner',
            duration: 20,
        ...
        this.tutorials.set('eye-render-tutorial', {
            ...
            description: 'Learn my process for creating realistic, expressive eyes in digital painting - from iris details to catchlights.',
            category: 'facial-features',
            difficulty: 'intermediate',
            duration: 25,
        ...
        this.tutorials.set('lip-rendering-tutorial', {
            ...
            description: 'Learn to render realistic lips with proper texture, highlights, shadows, and lighting.',
            category: 'facial-features',
            difficulty: 'intermediate',
            duration: 18,
        ...
        this.tutorials.set('skin-rendering-tutorial', {
            ...
            description: 'Master skin rendering with pores, subsurface scattering, textures, and realistic lighting.',
            category: 'facial-features',
            difficulty: 'advanced',
            duration: 40,
        ...
        this.tutorials.set('facial-expressions', {
            ...
            description: 'Learn to create realistic and emotional facial expressions - happiness, sadness, anger, surprise, and more.',
            category: 'facial-features',
            difficulty: 'intermediate',
            duration: 35,
        ...
        this.tutorials.set('clipstudio-basics', {
            ...
            description: 'Learn the essentials of Clip Studio Paint - from interface navigation to essential tools for manga and illustration.',
            category: 'software',
            difficulty: 'beginner',
            duration: 35,
        ...
        this.tutorials.set('krita-basics', {
            id: 'krita-basics',
            title: 'Krita Basics',
            description: 'Master the powerful open-source painting software Krita - brushes, layers, and professional features.',
            category: 'software',
            difficulty: 'beginner',
            duration: 30,
        ...
        this.tutorials.set('photoshop-basics', {
            ...
            description: 'Learn Photoshop specifically for digital painting - brushes, layers, masks, and essential tools.',
            category: 'software',
            difficulty: 'intermediate',
            duration: 40,
        ...
        this.tutorials.set('procreate-guide', {
            ...
            description: 'Master Procreate on iPad - from basic gestures to advanced illustration techniques.',
            category: 'software',
            difficulty: 'beginner',
            duration: 35,
        ...
        this.tutorials.set('software-comparison', {
            ...
            description: 'Compare the best digital art software - Photoshop, Procreate, Clip Studio, Krita, and more to find your perfect match.',
            category: 'software',
            difficulty: 'beginner',
            duration: 25,
        ...
        this.tutorials.set('portfolio-preparation', {
            ...
            description: 'Learn how to build a professional art portfolio that stands out to clients and employers.',
            category: 'workflow',
            difficulty: 'intermediate',
            duration: 35,
        ...
        this.tutorials.set('reference-usage', {
            ...
            description: 'Master the art of using references effectively without copying. Learn to gather, organize, and use references.',
            category: 'workflow',
            difficulty: 'beginner',
            duration: 25,
        ...
        this.tutorials.set('time-management', {
            ...
            description: 'Learn to manage your time effectively, beat procrastination, and build a sustainable creative routine.',
            category: 'workflow',
            difficulty: 'beginner',
            duration: 30,
            ...
            author: 'Dr. Kenji Tanaka',
            date: '2024-03-01',
            tags: ['time management', 'productivity', 'routine', 'workflow', 'efficiency']
        });

        this.tutorials.set('workflow-optimization', {
            id: 'workflow-optimization',
            title: 'Workflow Optimization',
            description: 'Streamline your creative process with organization techniques, shortcuts, and efficient practices.',
            category: 'workflow',
            difficulty: 'intermediate',
            duration: 40,
            ...
            author: 'Alex Chen',
            date: '2024-03-15',
            tags: ['workflow', 'optimization', 'organization', 'efficiency', 'productivity']
        });
    }
...
console.log('📚 Total tutorials:', window.tutorialData.getAllTutorials().length);
console.log('📂 Categories:', window.tutorialData.getAllCategories().map(c => c.name).join(', '));
